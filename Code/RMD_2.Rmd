...
plot <- summary %>%
  ...
  geom_point(position = position_dodge(1), aes(size = 2)) + theme_classic() +
  ylim(-0.2, 2.5) + labs(x = 'Assay correlations',
                         y = 'Posterior mean',
...
#need to join in wide format then change to long format
...
data_loco_ymaze_startle$Sex.x <- as.factor(data_loco_ymaze_startle)
