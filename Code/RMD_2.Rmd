...
Anova(m6b)#model used in manuscript

anova(m6b,m6) #can remove Treatment*startle_number but I think it makes sense to keep because it's closely related to our hypotheses

m6c <- lmer(log(distance +1) ~ Sex*Treatment*startle_number + (1|Batch) + (1|Individual_ID), data = data_startle_act_reduced)

Anova(m6c) #three-way interaction is significant
