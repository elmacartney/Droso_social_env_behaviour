...
#TODO does it make more sense to have type in the 3-way interaction??
...
m6c <- lmer(distance ~ Sex*Treatment*startle_number + (1|Batch) + (1|Individual_ID), data = data_startle_act_reduced)
