...
#TODO change chunk, model, and plot labels
...
#MEAN MODELS
#removing flies that were not moving etc
...
#CORRELATION DATA
#removing flies that we lost track of
...
#joining data for correlation analysis
...
## Data processing for the data used above {.tabset}
...
```{r locomotion treatment and sex effects}
...
```{r ymaze mean effect}
#differences between types of trigram
